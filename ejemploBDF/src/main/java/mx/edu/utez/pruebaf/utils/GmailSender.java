    ...
    public class GmailSender {
        ...
        public static void main(String[] args) throws Exception {
            new GmailSender().sendMail("dericklagunes@utez.edu.mx","A new message",
                    "<h1>ChavezArredondo Juan Manuel</h1>"+
            "<h1>Madrigal Perez Zujeily Johemi</h1>"+
            "<h1>Perez Caspeta Hanna Romybsi<h1>"+
                    "<h1>Rojas Vargas Luis David<h1>"+
                            "<h1>Mejia Barrera Roberto Gustavo<h1>");
        }
